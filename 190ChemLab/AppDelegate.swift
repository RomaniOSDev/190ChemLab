...
class AppDelegate: UIResponder, UIApplicationDelegate, MessagingDelegate, UNUserNotificationCenterDelegate {
    ...
    private func configureAppsFlyer() {
        ...
        AppsFlyerLib.shared().appleAppID = "6784685457"
        AppsFlyerLib.shared().delegate = self
        AppsFlyerLib.shared().deepLinkDelegate = self
        AppsFlyerLib.shared().start()

        // TODO: Add GoogleService-Info.plist to the app target, then FirebaseApp.configure() will load it.
        if Bundle.main.path(forResource: "GoogleService-Info", ofType: "plist") != nil {
            ...
            print("⚠️ GoogleService-Info.plist missing — Firebase not configured. Add the plist from Firebase Console.")
        }
    }
